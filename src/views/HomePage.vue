    ...
    <div class="max-w-md mx-auto mt-4 bg-white p-6 rounded-lg shadow-md">
      ...
      <form @submit.prevent="registerUser">
        <div class="mb-4">
          ...
          <input v-model="name" type="text" class="mt-1 p-2 w-full border rounded-md" placeholder="enter your name">
        </div>
    
        <div class="mb-4">
          <label class="block text-gray-700 font-medium ">Email</label>
          <input v-model="email" type="email" class="mt-1 p-2 w-full border rounded-md" placeholder="enter your email">
        </div>
    
        <div class="mb-4">
          <label class="block text-gray-700 font-medium ">Password</label>
          <input v-model="password" type="password" class="mt-1 p-2 w-full border rounded-md" placeholder="enter your password">
        </div>
    ...
    methods:{
        async registerUser(){
            ...
            try {
                ...
                this.$toast.error('an error ocured during registration');
                this.success = false;
